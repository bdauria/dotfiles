...
describe('Table', function () {
  ...
  describe('children', function () {
    it('should accept Column children', function () {
      var children = [React.createElement(Column, { dataKey: 'foo', width: 100 })];
    ...
    it('should accept subclasses of Column as children', function () {
      var AnotherColumn = function (_Column) {
        ...
        function AnotherColumn() {
          ...
          return _possibleConstructorReturn(this, (AnotherColumn.__proto__ || _Object$getPrototypeOf(AnotherColumn)).apply(this, arguments));
        }

        return AnotherColumn;
      }(Column);

      var children = [React.createElement(AnotherColumn, { dataKey: 'foo', width: 100 })];
      var result = Table.propTypes.children({ children: children }, 'children', 'Table');
      expect(result instanceof Error).toEqual(false);
    });
    ...
    it('should accept falsy children to allow easier dynamic showing/hiding of columns', function () {
      var children = [false, React.createElement(Column, { dataKey: 'foo', width: 100 }), null];
      var result = Table.propTypes.children({ children: children }, 'children', 'Table');
      expect(result instanceof Error).toEqual(false);
    });
  });
