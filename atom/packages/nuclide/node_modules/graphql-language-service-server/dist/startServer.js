...
exports.default = function startServer(options) {
  var logger, reader, writer, _port, socket, connection;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = _context.t0 === 'socket' ? 7 : _context.t0 === 'stream' ? 14 : _context.t0 === 'node' ? 17 : 17;
          break;
...
function addHandlers(connection, configDir, logger) {
  ...
  var messageProcessor = new _MessageProcessor.MessageProcessor(logger);
    ...
    return regeneratorRuntime.async(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap(messageProcessor.handleDidOpenOrSaveNotification(params));
    ...
    return regeneratorRuntime.async(function _callee3$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return regeneratorRuntime.awrap(messageProcessor.handleDidChangeNotification(params));
