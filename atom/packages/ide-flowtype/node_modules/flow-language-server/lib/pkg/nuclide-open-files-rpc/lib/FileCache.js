...
class FileCache {
  ...
  update(updateBufferAndMakeEventFunc) {
    ...
    (0, _assert2.default)(event.kind !== 'edit' || this.getBufferForFileEvent(event));
  ...
  getTotalBufferSize() {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      const addLength = function addLength(acc, { buffer }) {
  ...
  observeFileEvents() {
    return _rxjs.Observable.from(Array.from(this._buffers.entries()).map(([filePath, { buffer, languageId }]) => {
      (0, _assert2.default)(buffer != null);
      (0, _assert2.default)(languageId != null);
