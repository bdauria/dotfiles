...
var _findExports2 = require('../findExports');

var _findExports3 = _interopRequireDefault(_findExports2);
  ...
  isopackVer.builds.forEach(function (build) {
    ...
    if (buildIsopack.resources) {
      ...
      if (mainModuleResource) {
        var pathToRequiredFile = _path2['default'].join(isopackRoot, mainModuleResource.file);
        ...
        var _findExports = (0, _findExports3['default'])(requiredFileContent, pathToRequiredFile),
...
function meteorPackageNamedExports(_ref2) {
  ...
  meteorPackageDependencies({ config }).forEach(function (meteorPkg) {
...
exports['default'] = {
    ...
    ['.html', '.css'].forEach(function (ext) {
      ...
      if (_fs2['default'].existsSync(_path2['default'].join(config.workingDirectory, moduleSpecifier))) {
        if (config.get('useRelativePaths')) {
          moduleSpecifiers.push('./' + String(_path2['default'].basename(moduleSpecifier)));
        } else {
  ...
  packageDependencies(_ref6) {
    var config = _ref6.config;

    var npmPackages = (0, _findPackageDependencies2['default'])(config.workingDirectory, config.get('importDevDependencies'));

    return new Set([].concat(_toConsumableArray(meteorPackageDependencies({ config })), _toConsumableArray(Array.from(npmPackages))));
  }
};
